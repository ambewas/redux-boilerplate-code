// code courtesy of https://github.com/icapps/react-silverback/blob/development/src/redux/middleware/promiseMiddleware.js

export const PENDING = "PENDING";
export const RESOLVED = "RESOLVED";
export const REJECTED = "REJECTED";

const defaultTypes = [ PENDING, RESOLVED, REJECTED ];
...
const promiseMiddleware = (config = {}) => {
	...
	return ref => {
		...
		return next => action => {
			...
			const [ _PENDING, _RESOLVED, _REJECTED ] = promiseTypeSuffixes;

			const getAction = (newPayload, isRejected) => ({
				type : [ type, isRejected ? _REJECTED : _RESOLVED ].join(promiseTypeSeparator),
